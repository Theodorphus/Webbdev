...
export default function SiteFooter() {
  ...
  return (
      <footer className="border-t border-foreground/[0.07] py-14">
          ...
          <div className="flex flex-wrap items-start justify-between gap-10">
            ...
            <div className="flex flex-wrap gap-16">
              <div className="flex flex-col gap-2 text-[13px]">
                ...
                <a href={`${home}#process`} className="text-muted transition-colors hover:text-foreground">{t.nav2.process}</a>
                <Link href="/gratis-demo" className="text-accent-light hover:text-foreground">{t.nav2.demo}</Link>
                <Link href={localizedHref("/priser", lang)} className="text-muted transition-colors hover:text-foreground">{t.nav2.priser}</Link>
                <a href={`${home}#om`} className="text-muted transition-colors hover:text-foreground">{t.nav2.om}</a>
                <Link href={localizedHref("/tjanster", lang)} className="text-muted transition-colors hover:text-foreground">{t.footer2.tjanster}</Link>
                <Link href={localizedHref("/portfolio", lang)} className="text-muted transition-colors hover:text-foreground">{t.footer2.portfolio}</Link>
              ...
              <div className="flex flex-col gap-2 text-[13px]">
                ...
                <a href="mailto:webbdevstudio@gmail.com" className="text-muted transition-colors hover:text-foreground">
