...
const primaryClass = 'inline-flex items-center justify-center gap-3 rounded-full bg-accent px-5 py-3.5 text-sm font-semibold text-on-accent transition-colors hover:bg-[#7773ff] disabled:cursor-wait disabled:opacity-60';
const subtleButton = 'rounded-lg px-3 py-2 text-xs text-foreground/65 transition-colors hover:bg-foreground/10 hover:text-foreground';
              ...
              <form onSubmit={submit} className="mt-5">
                <fieldset disabled={status === 'sending' || !storageReady} className="min-w-0 space-y-5"><legend className="sr-only">{steps[step]}</legend>
                  ...
                  {step === 1 && <>
                    ...
                    <div className="rounded-xl bg-foreground/[0.03] p-4 text-xs leading-relaxed text-muted">Typografi, färger och bildspråk samverkar. Det personliga designförslaget anpassas sedan efter ditt varumärke.</div>
                  </>}
                  {step === 2 && <>
